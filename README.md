...
Если нужен Telegram-прокси «включил и забыл», этот репозиторий делает именно это. Один скрипт ставит всё на чистой Ubuntu, собирает MTProxy из официальных исходников и выдаёт готовую ссылку для подключения. Без Docker и без лишних шагов.
